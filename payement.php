...
$conn->query($sql);
 ...
 echo '<script type="text/javascript">window.location="payement.php?act=1";</script>';
}
}
...
<head>
    ...
    <title>Paiement Stagiaire</title>
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">PAYEMENT
...
<form class="form-inline" role="form" id="searchform">
  ...
  <div class="form-group">
    ...
    <select  class="form-control" id="branch" name="branch" >
		<option value="" >Choisir la domaine</option>
                                    <?php
  ...
  <button type="reset" class="btn btn-danger btn-sm" id="clear" > Retour </button>
</form>
</fieldset>
...
function mydatatable()
{
              ...
              $("#subjectresult").html('<table class="table table-striped table-bordered table-hover" id="tSortable22"><thead><tr><th>Nom/Contact</th><th>Paiement</th><th>Restant</th><th>Domaine</th><th>Date de debut</th><th>Action</th></tr></thead><tbody></tbody></table>');
