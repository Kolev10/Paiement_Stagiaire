...
$res = $q->fetch_assoc();
echo '  <form class="form-horizontal" id ="signupForm1" action="payement.php" method="post">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">Total à payer:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">Restant:</label>
    <div class="col-sm-10">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="email">Date de payement:</label>
    <div class="col-sm-10">
