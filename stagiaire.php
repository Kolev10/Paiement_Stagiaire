...
$branch = mysqli_real_escape_string($conn,$_POST['branch']);
 ...
 $conn->query("INSERT INTO  fees_transaction (stdid,paid,submitdate,transcation_remark) VALUES ('$sid','$advancefees','$joindate','$remark')") ;
   ...
   echo '<script type="text/javascript">window.location="stagiaire.php?act=1";</script>';
 ...
 $id = mysqli_real_escape_string($conn,$_POST['id']);	
   ...
   echo '<script type="text/javascript">window.location="stagiaire.php?act=2";</script>';
 }
...
header("location: stagiaire.php?act=3");
...
{
$errormsg = "<div class='alert alert-success'> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Success!</strong> Stagiaire ajouté avec succès</div>";
}else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="2")
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong>Success!</strong> Stagiaire modifié avec succès</div>";
}
else if(isset($_REQUEST['act']) && @$_REQUEST['act']=="3")
{
$errormsg = "<div class='alert alert-success'><a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong>Success!</strong> Stagiaire supprimé avec succès</div>";
}
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">STAGIAIRES 
						<?php
						echo (isset($_GET['action']) && @$_GET['action']=="add" || @$_GET['action']=="edit")?
						' <a href="stagiaire.php" class="btn btn-primary btn-sm pull-right">Retour <i class="glyphicon glyphicon-arrow-right"></i></a>':'<a href="stagiaire.php?action=add" class="btn btn-primary btn-sm pull-right"><i class="glyphicon glyphicon-plus"></i> Ajouter </a>';
						?>
						</h1>
			...
			<script type="text/javascript" src="js/validation/jquery.validate.min.js"></script>
               ...
               <div class="panel panel-primary">
                        <div class="panel-heading">
                           <?php echo ($action=="add")? "Ajouter Stagiaire": "Modifier Stagiaire"; ?>
                        </div>
						<form action="stagiaire.php" method="post" id="signupForm1" class="form-horizontal">
                        <div class="panel-body">
						<fieldset class="scheduler-border" >
						 <legend  class="scheduler-border">Informations Personnelles:</legend>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Prénom et Nom</label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Numéro de Téléphone</label>
								<div class="col-sm-10">
						 ...
						 <fieldset class="scheduler-border" >
						 <legend  class="scheduler-border">Informations facultatives</legend>
							
						 <div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Domaine</label>
								<div class="col-sm-10">
						    ...
						    <div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Date de début</label>
								<div class="col-sm-10">
							...
							<fieldset class="scheduler-border" >
						 <legend  class="scheduler-border">Renseignements sur le payement:</legend>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Total à payer</label>
								<div class="col-sm-10">
						...
						?>
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Remboursé</label>
								<div class="col-sm-10">
						...
						<div class="form-group">
								<label class="col-sm-2 control-label" for="Old">Restant</label>
								<div class="col-sm-10">
                            ...
                            <div class="table-sorting table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="tSortable22">
									...
									echo '<tr '.(($r['balance']>0)?'class="danger"':'').'>
											...
											<a href="stagiaire.php?action=edit&id='.$r['id'].'" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-edit"></span></a>
											
											<a onclick="return confirm(\'Are you sure you want to delete this record\');" href="stagiaire.php?action=delete&id='.$r['id'].'" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span></a> </td>
