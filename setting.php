...
$sql = "select * from user where id= '".$_SESSION['kolev_uid']."' and password='".md5($oldpassword )."'";
$q = $conn->query($sql);
if($q->num_rows>0)
{

$sql = "update user set  password = '".md5($newpassword)."' WHERE id = '".$_SESSION['kolev_uid']."'";
$r = $conn->query($sql);
...
<head>
    ...
    <title>Systeme de Paiement</title>
...
?>
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Configuration mot de passe</h1>
...
?>
               ...
               <div class="panel panel-primary">
						...
						<div class="form-group">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="Confirm">Confirmer</label>
								<div class="col-sm-5">
